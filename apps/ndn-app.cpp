...
/*
  //m_allNodeName = {'/user-', '/r1-','/r2-','/r3-','/m1-','/m2-','/m3-','/m4-','/m5-'};
  m_allNodeName.push_back("/user-");
  m_allNodeName.push_back("/r1-");
  m_allNodeName.push_back("/r2-");
  //m_allNodeName.push_back("/r3-");
  ...
  m_allNodeName.push_back("/c1-");
  m_allNodeName.push_back("/c2-");
  m_allNodeName.push_back("/c3-");
  m_allNodeName.push_back("/c4-");
  m_allNodeName.push_back("/c5-");
*/
